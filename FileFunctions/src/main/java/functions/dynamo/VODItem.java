...
@DynamoDBTable(tableName="SignedVODTable")
public class VODItem {
    ...
    public static VODItem make(String uid, String sid, String oid, String name) {
        ...
        System.out.println("[VOD] uid:"+uid+", sid:"+sid+", oid:"+oid);
        return item;
    }
